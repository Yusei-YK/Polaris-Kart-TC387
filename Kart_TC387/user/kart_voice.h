 ...
 *   FB          : 固定帧尾
 *
 * 串口: UART_1 @115200 8N1 (BOARD_WIRELESS_UART_*, P33.12 TX / P33.13 RX)
 *       注意:原 VOFA 无线串口已停用,P33.12/P33.13 现复用给语音模块。
 ...
 *   灯光(0x04~0x0B)  → 留空(灯板未就绪,7x14 阵列显示映射待定)
 *   门洞(0x15~0x1E)  → 留空(导航模块待接)
 *   动作(0x1F~0x26)  → 留空(运动控制模块待接)
