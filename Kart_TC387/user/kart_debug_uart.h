 ...
 *   当前 16 通道:ch0=目标速度 ch1=实测均值 ch2=yaw ch3=center_delta
 *               ch4=target_delta ch5=转向输出duty ch6=target_yaw
 *               ch7=左滤波速 ch8=右滤波速 ch9=左PI输出 ch10=右PI输出
 *               ch11=累计路程(m) ch12=odom_x(m) ch13=odom_y(m)
 *               ch14=左累计脉冲 ch15=右累计脉冲
 * ------------------------------------------------------------------
 ...
 *   z       在 e0 状态下清零左右累计脉冲和里程,用于每次标定前归零
 * ------------------------------------------------------------------
 */
